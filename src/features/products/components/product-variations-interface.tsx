          ...
          <div className="rounded-md bg-blue-50 p-4">
            <div className="text-sm text-blue-800">
              ...
              <div className="text-xs space-y-1">
                ...
                <div>• Each variation combination has its own composition template</div>
                <div>• You define variations by creating different composition combinations</div>
                <div>• No traditional variation types are used for composite products</div>
              </div>
            </div>
          </div>
