...
export function VariationList({
  ...
  const [selectedVariationTypeFilter, setSelectedVariationTypeFilter] =
    useState(filterByVariationType || "");
  ...
  const filteredVariations = variations.filter((variation) => {
    if (
      selectedVariationTypeFilter &&
      variation.variationTypeId !== selectedVariationTypeFilter
    ) {
      return false;
    }
    if (searchQuery.trim()) {
    ...
    },
    {
      ...
      render: (_, variation: Variation) => {
        const variationType = variationTypes.find(
          (vt) => vt.id === variation.variationTypeId
        );
        return (
          <div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  You need to create variation types before you can create
                  variations.{" "}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700">
              Are you sure you want to delete the variation &ldquo;
              {deletingVariation.name}&rdquo;? This action cannot be undone.
            </p>
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      This variation cannot be deleted if it is being used in
                      any product variations. Please remove it from all products
                      first.
                    </p>
                  </div>
                </div>
