...
describe("AccessibleTable", () => {
  it("renders table with data", () => {
    render(<AccessibleTable data={mockData} columns={mockColumns} />);
  ...
  it("shows loading state", () => {
    render(<AccessibleTable data={[]} columns={mockColumns} loading={true} />);
  ...
  it("renders sortable column headers", () => {
    const onSort = vi.fn();
    render(
      <AccessibleTable data={mockData} columns={mockColumns} onSort={onSort} />
    );
  ...
  it("uses custom render function for columns", () => {
    ...
    render(<AccessibleTable data={mockData} columns={columnsWithRender} />);
