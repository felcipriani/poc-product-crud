...
vi.mocked(CompositionService).mockImplementation(
...
describe("useComposition", () => {
  ...
  describe("Initial loading", () => {
    it("should load composition items on mount", async () => {
      ...
      expect(mockCompositionService.getCompositionItems).toHaveBeenCalledWith(
        productSku
      );
    ...
    it("should load available items on mount", async () => {
      ...
      expect(
        mockCompositionService.getCompositionAvailableItems
      ).toHaveBeenCalled();
    ...
    it("should calculate total weight on mount", async () => {
      ...
      mockCompositionService.calculateCompositeWeight.mockResolvedValue(
        expectedWeight
      );
      ...
      expect(
        mockCompositionService.calculateCompositeWeight
  ...
  describe("CRUD operations", () => {
    it("should create composition item", async () => {
      ...
      expect(mockCompositionService.createCompositionItem).toHaveBeenCalledWith(
        createData
      );
      expect(mockCompositionService.getCompositionItems).toHaveBeenCalledTimes(
        2
      ); // Initial + after create
      expect(
        mockCompositionService.calculateCompositeWeight
      ).toHaveBeenCalledTimes(2); // Initial + after create
    });
    ...
    it("should update composition item", async () => {
      ...
      expect(mockCompositionService.updateCompositionItem).toHaveBeenCalledWith(
        "comp-1",
        updateData
      );
      expect(mockCompositionService.getCompositionItems).toHaveBeenCalledTimes(
      ...
      expect(
        mockCompositionService.calculateCompositeWeight
      ).toHaveBeenCalledTimes(2); // Initial + after update
    });
    ...
    it("should delete composition item", async () => {
      ...
      expect(mockCompositionService.deleteCompositionItem).toHaveBeenCalledWith(
        "comp-1"
      );
      expect(mockCompositionService.getCompositionItems).toHaveBeenCalledTimes(
        2
      ...
      expect(
        mockCompositionService.calculateCompositeWeight
      ).toHaveBeenCalledTimes(2); // Initial + after delete
    });
  });
  ...
  describe("Error handling", () => {
    it("should handle loading errors", async () => {
      ...
      mockCompositionService.getCompositionItems.mockRejectedValue(
    ...
    it.skip("should handle create errors", async () => {
      const errorMessage = "Failed to create composition item";
      mockCompositionService.createCompositionItem.mockRejectedValue(
        new Error(errorMessage)
      );
    ...
    it.skip("should handle update errors", async () => {
      ...
      mockCompositionService.updateCompositionItem.mockRejectedValue(
        new Error(errorMessage)
      );
    ...
    it.skip("should handle delete errors", async () => {
      ...
      mockCompositionService.deleteCompositionItem.mockRejectedValue(
        new Error(errorMessage)
      );
  ...
  describe("Utility functions", () => {
    it("should validate composition", async () => {
      ...
      expect(
        mockCompositionService.validateCompositionComplexity
      ).toHaveBeenCalledWith(productSku);
    ...
    it("should get composition tree", async () => {
      ...
      expect(mockCompositionService.getCompositionTree).toHaveBeenCalledWith(
        productSku
      );
    ...
    it("should refresh all data", async () => {
      ...
      expect(
        mockCompositionService.getCompositionAvailableItems
      ).toHaveBeenCalledTimes(2); // Initial + refresh
      expect(
        mockCompositionService.calculateCompositeWeight
      ).toHaveBeenCalledTimes(2); // Initial + refresh
    });
  ...
  describe("Variation SKU parsing", () => {
    it("should parse hash format variation SKUs", async () => {
      ...
      expect(mockVariationItemRepository.findById).toHaveBeenCalledWith(
        "var-123"
      );
    });
