...
import { CompositionItemEntity, CompositionItemSchema } from "@/lib/domain/entities/composition-item";
...
describe("CompositionItemEntity", () => {
  ...
  describe("updates", () => {
    it("should update composition item fields", async () => {
      const original = CompositionItemEntity.create(createTestUuid(), validData);
