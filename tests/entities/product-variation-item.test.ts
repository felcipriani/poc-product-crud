...
describe("ProductVariationItemEntity", () => {
  ...
  describe("selection comparison", () => {
    it("should detect same selections", () => {
      const item1 = ProductVariationItemEntity.create(createTestUuid(), validData);
      const item2 = ProductVariationItemEntity.create(createTestUuid(), {
        ...validData,
  ...
  describe("variation SKU generation", () => {
    ...
    it("should generate consistent SKU for same selections", () => {
      const item1 = ProductVariationItemEntity.create(createTestUuid(), validData);
      const item2 = ProductVariationItemEntity.create(createTestUuid(), validData);
  ...
  describe("updates", () => {
    it("should update selections", async () => {
      const original = ProductVariationItemEntity.create(createTestUuid(), validData);
    ...
    it("should update overrides", () => {
      ...
      expect(updated.dimensionsOverride).toEqual({ height: 20, width: 30, depth: 40 });
