...
const mockUseVariations = useVariations as vi.MockedFunction<
  typeof useVariations
>;
...
describe("VariationList", () => {
  ...
  it("opens create modal when create button is clicked", async () => {
    ...
    const createButton = screen.getByRole("button", {
      name: /create variation/i,
    });
    await user.click(createButton);

    expect(
      screen.getByRole("heading", { name: "Create Variation" })
    ).toBeInTheDocument();
  });
  ...
  it("opens delete confirmation when delete button is clicked", async () => {
    ...
    expect(
      screen.getByText(/are you sure you want to delete.*red/i)
    ).toBeInTheDocument();
  });
  ...
  it("shows warning when no variation types exist", () => {
    ...
    expect(
      screen.getByText(/you need to create variation types/i)
    ).toBeInTheDocument();
  });
  ...
  it("renders selectable mode correctly", () => {
    ...
    render(
      <VariationList selectable={true} onVariationSelect={mockOnSelect} />
    );
