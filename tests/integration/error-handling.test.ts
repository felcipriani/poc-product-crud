...
describe('Error Handling Integration', () => {
  ...
  describe('Error Classification and User Feedback', () => {
    it('should classify validation errors correctly', () => {
      const validationError = new ValidationError('SKU is required', 'sku', 'required');
  ...
  describe('Toast Notifications', () => {
    ...
    it('should show user-friendly messages for technical errors', async () => {
      ...
      const message = getUserFriendlyMessage(error);
      expect(message).toBe('There was a problem saving your data. Please try again.');
    });
  });
  ...
  describe('Error Message Generation', () => {
    it('should generate user-friendly messages for different error types', () => {
      ...
      const businessError = new BusinessRuleError('Business rule violated', 'rule');
      ...
      expect(getUserFriendlyMessage(businessError)).toBe('Business rule violated');
      expect(getUserFriendlyMessage(storageError)).toBe('There was a problem saving your data. Please try again.');
      expect(getUserFriendlyMessage(unknownError)).toBe('Something went wrong. Please try again.');
    });
